 ...
 *
 * All real-time state is managed by the `useRoom` hook (Pusher + Supabase).
 * This component is purely presentational: it wires hook outputs to UI components.
 */
            ...
            {!connected && (
              ...
              >
                ...
                <p style={{ margin: 0, fontSize: "0.85rem", color: "var(--text-secondary)" }}>
                  <strong style={{ color: "var(--brand-violet-light)" }}>Connecting to room…</strong>{" "}
                  Establishing real-time connection via Pusher. This usually takes less than a second.
                </p>
              </div>
            )}
          </div>
